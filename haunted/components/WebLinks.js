      ...
      <LinkWrapper>
        <LinkContainer>
          <TopPart>
            ...
            <WebLinkWrap>
              {/* Social Icon */}
              <LinkSection className="socialDELETETHIS">
                      ...
                      <h3>Support</h3>
                      {
                        install.map((i) => {
                          return (
                              <a href={i.url} key={i.title} target="_blank" rel="noreferrer">
                                <LinkBoxDef>
                                  <LinkTitleSmaller><img src={i.icon} style={{ filter: 'var(--img)' }} /> {i.title}</LinkTitleSmaller> <NewUp />
                                </LinkBoxDef>
                              </a>
                          )
                        })
                      ...
                      <h3>Socials</h3>
                      {
                        nfts.map((i) => {
                          return (
                              <a href={i.url} key={i.title} target="_blank" rel="noreferrer">
                                <LinkBox>
                                  <LinkTitle><img src={i.icon} style={{ filter: '' }} /> {i.title}</LinkTitle> <NewUp />
                                </LinkBox>
                              </a>
                          )
                        })
                    ...
                    <LinkSection>
                      ...
                      {/* End Biodata.js, You can move this section anywhere */}
                      {
                        others.map((i) => {
                          return (
                              <a href={i.url} key={i.title} target="_blank" rel="noreferrer">
                                <LinkBoxWhy className="socialIcon">
...
`
const LinkTitleSmaller = styled.div`
  display: flex;
  font-size: 18px;
  align-items: center;
    @media screen and (max-width: ${({ theme }) => theme.deviceSize.tablet}) {
